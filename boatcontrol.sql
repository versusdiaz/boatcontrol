...
CREATE TABLE IF NOT EXISTS `boatcontrol`.`act` (
  ...
  `condicion` TINYINT NOT NULL DEFAULT 1,
  PRIMARY KEY (`idact`),
  UNIQUE INDEX `numact_UNIQUE` (`numact` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `boatcontrol`.`programas` (
  ...
  `idcentro` INT NOT NULL,
  `horasinicio` INT(25) NOT NULL,
  `fechainicio` DATE NOT NULL,
  `fechacierre` DATE NOT NULL,
  `condicion` TINYINT NOT NULL,
  PRIMARY KEY (`idprogramas`),
  INDEX `fk_programas_centro_idx` (`idcentro` ASC) ,
...
CREATE TABLE IF NOT EXISTS `boatcontrol`.`act_programas` (
  `idact_programas` INT NOT NULL AUTO_INCREMENT,
  `idact` INT NOT NULL,
  `idprogramas` INT NOT NULL,
  `idods_mtto` INT NULL,
  `horasplan` INT(25) NOT NULL,
  `horasrealizadas` INT(25) NOT NULL,
  `condicion` TINYINT NOT NULL,
  PRIMARY KEY (`idact_programas`),
  INDEX `fk_act_programas_act_idx` (`idact` ASC) ,
  INDEX `fk_act_programas_programas_idx` (`idprogramas` ASC) ,
  INDEX `fk_act_programas_ods_idx` (`idods_mtto` ASC) ,
  ...
  CONSTRAINT `fk_act_programas_programas`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_act_programas_ods`
    FOREIGN KEY (`idods_mtto`)
    REFERENCES `boatcontrol`.`ods_mtto` (`idods_mtto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
